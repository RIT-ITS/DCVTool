...
<!-- /.navbar -->
 ...
 <aside class="main-sidebar sidebar-no-expand sidebar-light-primary  elevation--10">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card" id="uncertainty_wrapper">
              <!--card header-->

              <div class="card-header">
                <h3 class="card-title">Additional seats and occupancy to be added to Space Capacity and Event Population according to its ASHRAE 621. Occupancy Category</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <table id="uncertaintyTable" class="table table-bordered table-striped">
                  <thead>
                      <tr>
                          <td></td>
                          <th>Id</th>
                          <th>Amount</th>
                          <th>Description</th>
                          <th>ASHRAE 62.1 Occupancy Category</th>
                      </tr>
                  </thead>
                  <tbody>
    ...
    <div id="addUncertaintyModal" class="modal">
      <div class="modal-content">
      <span class="close">&times;</span>
      <h2>Add Uncertainty Type</h2>
        <form id="uncertaintyForm">
          <label class="input customSelect" for="uncert_amt">Amount: </label>
          <input class="input customSelect" type="number" id="uncert_amt" name="uncert_amt" required><br>
          <label class="input customSelect" for="u_desc">Description: </label>
          <input class="input customSelect" type="text" id="u_desc" name="u_desc" required><br>
          <label class="input customSelect" for="ashrae_ids">ASHRAE 62.1 Occupancy Category: </label>
    ...
    <dialog id="alertUncertDel" autofocus="true">
      <div>
        <p class="alertTextDel">this is a dialog</p>
        <button style="margin-right: 10px" id="cancelUncertDel" class="btn btn-default">Cancel</button>
        <button id="confirmUncertDel" style="float: right" class="btn btn-danger">Delete</button>
      </div>
    </dialog>
  </div>
  <!-- /.content-wrapper -->
...
<!-- App Script -->
<script src="src/js/App-uncertainty.js"></script>
