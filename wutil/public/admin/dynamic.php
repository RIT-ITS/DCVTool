...
$pageTitle = "Dynamic Calculations";
?>
<!DOCTYPE html>
<!--
          ...
          <div class="col-12">
            ...
            <div class="card" id="event_airflow_wrapper">
              ...
              <div class="card-header">
                <h3 class="card-title">Dynamic Calculations</h3>
              </div>
              <!--.card body-->
              <div class="card-body">
                ...
                <label for="offset">From: </label>
                <input class="customInput" type="number" id="offset" name="offset" value="0">

                <label for="limit">To: </label>
                <input class="customInput" type="number" id="limit" name="limit" value="250">-->

                <label for="pageLen">On:</label>
                <input class="customInput" type="date" id="first_date" name="first_date">

                <label for="pageLen">To (optional):</label>
...
<!--App Script-->
<script src="src/js/App-dynamic.js"></script>
