...
<!-- /.navbar -->
 ...
 <aside class="main-sidebar sidebar-no-expand sidebar-light-primary  elevation--10">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card" id="updates_wrapper">
              <!--card header-->
              ...
              <div class="card-body">
                ...
                <table id="updatesTable" class="table table-bordered table-striped">
                  <thead>
                      <tr>
                          <th>Id</th>
                          <th>Table Name</th>
                          <th>Table Dev Name</th>
                          <th>Updated Row Id</th>
                          <th>Column</th>
                          <th>Old Value</th>
                          <th>New Value</th>
                          <th>Date</th>
    ...
    <dialog id="alertUpdatesDel" autofocus="true">
      <div>
        <p class="alertTextDel">this is a dialog</p>
        <button style="margin-right: 10px" id="cancelUpdatesDel" class="btn btn-default">Cancel</button>
        <button id="confirmUpdatesDel" style="float: right" class="btn btn-danger">Delete</button>
      </div>
    </dialog>
...
<!-- App Script -->
<script src="src/js/App-updates.js"></script>
