...
$pageTitle = "NCES/ASHRAE 62.1 Cross Reference";
?>
<!DOCTYPE html>
<!--
...
<!-- /.navbar -->
 ...
 <aside class="main-sidebar sidebar-no-expand sidebar-light-primary  elevation--10">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card" id="nces_wrapper">

              <!--card header-->
              <div class="card-header">
                <h3 class="card-title">Assign ASHRAE 62.1 Occupancy category based on NCES Space Use Category or Subcategory</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <table id="nces42Table" class="table table-bordered table-striped">
                  <thead>
                      <tr>
                          <th></th>
                          <th>Id</th>
                          <th>NCES Space Use Category</th>
                          <th>NCES Space Use Subcategory</th>
    ...
    <div id="addnces42Modal" class="modal">
      <div class="modal-content">
      <span class="close">&times;</span>
      <h2>Add NCES 4-2/Ashrae 6-1 Reference</h2>
        <form id="nces42Form">
          <label class="input customSelect" for="nces_category">NCES Space Use Category: </label>
          <div id="ncesCatHolder"></div><br>
          <label class="input customSelect" for="code">NCES Space Use Subcategory: </label>
          ...
          <label class="input customSelect" for="ashrae_61_ids">ASHRAE 62.1 Occupancy Category: </label>
    ...
    <dialog id="alert42Del" autofocus="true">
      <div>
        <p class="alertTextDel">this is a dialog</p>
        <button style="margin-right: 10px" id="cancel42Del" class="btn btn-default">Cancel</button>
        <button id="confirm42Del" style="float: right" class="btn btn-danger">Delete</button>
      </div>
    </dialog>
...
<!-- App Script -->
<script src="src/js/App4-2.js"></script>
