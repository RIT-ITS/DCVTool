...
$pageTitle = "Max Outdoor Airflow Per Room";
?>
<!DOCTYPE html>
<!--
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card" id="room_airflow_wrapper">
              <!--card header-->
              ...
              <div class="card-body">
                ...
                <table id="airflowTable" class="table table-bordered">
                  ...
                  <tr>
                      ...
                      <th>Space Name</th>
                      <th>Zone Name</th>
                      <th>ASHRAE Occpancy Category</th>
                      <th>Standby Mode</th>
                      <th>Area Az (sqft)</th>
                      <th>Max Population Pz_max</th>
                      <th>Area OA Rate Ra (cfm/sqft)</th>
...
<!--App Script-->
<script src="src/js/App-outdoorAirflowRooms.js"></script>
