...
<!-- /.navbar -->
 ...
 <aside class="main-sidebar sidebar-no-expand sidebar-light-primary  elevation--10">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card" id="building_wrapper">
              <!--card header-->
              <div class="card-header">
                <h3 class="card-title">Building Data</h3>
              </div>
              <!--.card body-->
              <div class="card-body">
    ...
    <div id="addBuildingModal" class="modal">
      <div class="modal-content">
        <div>
          ...
          <div class="h2 text-bold">Add Building</div>
        </div>
        <form id="buildingForm">
          <div class="mt-3 d-flex justify-content-between">
            <label class="input customSelect" for="bldg_num">Building Number: </label>
            <input class="input customSelect" type="text" id="bldg_num" name="bldg_num" required>
          </div>
          <div class="mt-3 d-flex justify-content-between">
            <label class="input customSelect" for="bldg_name">Building Name: </label>
            <input class="input customSelect" type="text" id="bldg_name" name="bldg_name" required>
          </div>
          <div class="mt-3 d-flex justify-content-between">
            <label class="input customSelect" for="facility_code">Building Code: </label>
            <input class="input customSelect" type="text" id="facility_code" name="facility_code" required>
          </div>
          <div class="mt-3 d-flex justify-content-between">
            <label class="input customSelect" for="short_desc">Description: </label>
            <input class="input customSelect" type="text" id="short_desc" name="short_desc" required>
          </div>
          <div class="mt-3 d-flex justify-content-between">
    ...
    <dialog id="alertBuildingDel" autofocus="true">
      <div>
        <p class="alertTextDel">this is a dialog</p>
        <button style="margin-right: 10px" id="cancelBuildingDel" class="btn btn-default">Cancel</button>
        <button id="confirmBuildingDel" style="float: right" class="btn btn-danger">Delete</button>
      </div>
    </dialog>
...
<!--App Script-->
<script src="src/js/App-buildings.js"></script>
