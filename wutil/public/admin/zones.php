 ...
 <aside class="main-sidebar sidebar-no-expand sidebar-light-primary elevation--10">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card" id="zone_wrapper">
              <!--card header-->
              <div class="card-header">
                <h3 class="card-title">VAV Zones</h3>
              </div>
              <!--.card body-->
              <div class="card-body">
                ...
                <table id="zonesTable" class="table table-bordered">
                  <thead>
                      <tr>
                          <th></th>
                          <th>Id</th>
                          <th>Name</th>
                          <th>Zone Code</th>
                          <th>Occupancy Sensor Present</th>
                          <th>Spaces Served by Zone</th>
                          <th>AHU</th>
                          <th>Active</th>
                      </tr>
                  </thead>
    ...
    <div id="addZoneModal" class="modal">
      ...
      <h2>Add Zone</h2>
        <form id="zoneForm">
          <label class="input customSelect" for="zone_name">Name: </label>
          <input class="input customSelect" type="text" id="zone_name" name="zone_name" required><br>
          <label class="input customSelect" for="zone_code">Zone Code: </label>
          <input class="input customSelect" type="text" id="zone_code" name="zone_code" required><br>
          <label class="input customSelect" for="occ_sensor">Occupancy Sensor Present: </label>
          <select class="input customSelect customInput" id="occ_sensor" name="occ_sensor" required>
            <option value="0">No</option>
            <option value="1">Yes</option>
          </select><br>
          <label class="input customSelect" for="xrefs">Spaces Served by Zone: </label>
          <input class="input customSelect" type="text" id="xrefs" name="xrefs" required><br>      
          <label class="input customSelect" for="ahu_name">AHU:</label>
    ...
    <dialog id="alertZonesDel" autofocus="true">
      <div>
        <p class="alertTextDel">this is a dialog</p>
        <button style="margin-right: 10px" id="cancelZonesDel" class="btn btn-default">Cancel</button>
        <button id="confirmZonesDel" style="float: right" class="btn btn-danger">Delete</button>
      </div>
    </dialog>
...
<!--App Script-->
<script src="src/js/App-zones.js"></script>
