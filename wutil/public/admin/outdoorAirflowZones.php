...
$pageTitle = "Max Outdoor Airflow Per Zone";
?>
<!DOCTYPE html>
<!--
...
<!-- /.navbar -->
 ...
 <aside class="main-sidebar sidebar-no-expand sidebar-light-primary  elevation--10">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card" id="zone_airflow_wrapper">
              <!--card header-->
              ...
              <div class="card-body">
                ...
                <table id="airflowTable" class="table table-bordered">
                  ...
                  <tr>
                      ...
                      <th>Standby Mode</th>
                      <th>Area Az (sqft)</th>
                      <th>Oa_area Vbza = RaAz (cfm)</th>
                      <th>Max Population Pz_max</th>
                      <th>Oa_people VbzP=Rp.Pz_Max (cfm)</th>
                  </tr>
                  </thead>
                  <tbody>
    ...
    <dialog id="alertAirflowDel" autofocus="true">
      <div>
        <p class="alertTextDel">this is a dialog</p>
        <button id="cancelAirflowDel" class="btn btn-default">Cancel</button>
        <button id="confirmAirflowDel" style="float: right" class="btn btn-danger">Delete</button>
      </div>
    </dialog>

    <!--Dialog box for auto calculations-->
    <dialog id="alertAirflowAuto" autofocus="true">
      <div>
        <p class="alertTextAuto">this is a dialog</p>
        <button id="cancelAirflowAuto" class="btn btn-default">Cancel</button>
        <button id="confirmAirflowAuto" style="float: right" class="btn btn-danger">Confirm</button>
      </div>
    </dialog>
...
<!--App Script-->
<script src="src/js/App-outdoorAirflowZones.js"></script>
