 ...
 <aside class="main-sidebar sidebar-no-expand sidebar-light-primary  elevation--10">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card" id="campus_wrapper">
              <!--card header-->

              <div class="card-header">
                <h3 class="card-title">Campus Data</h3>
              </div>
    ...
    <div id="addCampusModal" class="modal">
      ...
      <h2>Add Campus</h2>
        <form id="campusForm">
          <label class="input customSelect" for="campus_num">Campus Number: </label>
          <input class="input customSelect" type="text" id="campus_num" name="campus_num" required><br>
          <label class="input customSelect" for="code">Campus Code: </label>
          <input class="input customSelect" type="text" id="code" name="code" required><br>
          <label class="input customSelect" for="campus_name">Campus Name: </label>
          <input class="input customSelect" type="text" id="campus_name" name="campus_name" required><br>
          <label class="input customSelect" for="utc_offset">UTC Offset: </label>
          <input class="input customSelect" type="text" id="utc_offset" name="utc_offset" pattern="UTC-\d+|UTC[+]\d+" required><br>
    ...
    <dialog id="alertCampusDel" autofocus="true">
      <div>
        <p class="alertTextDel">this is a dialog</p>
        <button style="margin-right: 10px" id="cancelCampusDel" class="btn btn-default">Cancel</button>
        <button id="confirmCampusDel" style="float: right" class="btn btn-danger">Delete</button>
      </div>
    </dialog>
...
<!-- App Script -->
<script src="src/js/App-campuses.js"></script>
